...
class TitulCisController {
	...
	def index() {
		respond response:responseSCService.gridResponse(TitulCis.class,params)
	}

	@Transactional
	def save() {
		TitulCis instance = TitulCis.newInstance(params)
		...
		TitulCis.withTransaction {status->
			try {
