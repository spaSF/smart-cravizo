...
class RegDomCisController {
	...
	def index() {
		respond response:responseSCService.gridResponse(RegDomCis.class,params)
	}

	@Transactional
	def save() {
		RegDomCis instance = RegDomCis.newInstance(params)
		...
		RegDomCis.withTransaction {status->
			try {
