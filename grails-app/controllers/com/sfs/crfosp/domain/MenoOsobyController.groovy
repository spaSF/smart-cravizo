...
class MenoOsobyController {
	...
	def index() {
		...
		respond response:responseSCService.gridResponse(MenoOsoby.class,params)
	}

	@Transactional
	def save() {
		MenoOsoby instance = MenoOsoby.newInstance(params)
		...
		MenoOsoby.withTransaction {status->
			try {
