...
class PobytController {
	...
	def index() {
		...
		respond response:responseSCService.gridResponse(Pobyt.class,params)
	}

	@Transactional
	def save() {
		Pobyt instance = Pobyt.newInstance(params)
