...
//            writeRESTfulEndpoints(writer, basePath, restDestinations);
    ...
    private void writeSOAPEndpoints(PrintWriter writer,
    	...
    	writer.write("<span class=\"heading\"></span><br/>");
    	writer.write("<span class=\"heading\"> SOAP služby:</span><br/>");
...
//                     + absoluteURL + "</span>");
        writer.write("<span class=\"field\">Adresa endpointu:</span> " + "<span class=\"value\">"
                + absoluteURL + "</span>");
        writer.write("<br/><span class=\"field\">WSDL :</span> " + "<a href=\"" + absoluteURL
                     + "?wsdl\" target=\"_blank\">" + sd.getEndpointInfo().getService().getName() + "</a>");
